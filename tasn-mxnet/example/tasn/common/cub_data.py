...
def get_rec_iter(args, kv=None):
	...
	path_root	    = 'data/', 
		...
		path_imgrec      = './data/cub/train.rec',
		path_imgidx     = './data/cub/train.idx',
...
#        max_aspect_ratio    = 0.5,
	...
	path_root	    = 'data/', 
		...
		path_imgrec      = './data/cub/val.rec',
		path_imgidx     = './data/cub/val.idx',
        batch_size          = args.batch_size,
        data_shape          =  (3, 512, 512),
        resize		    = 512, 
        mean_r              = rgb_mean[0],
...
class custom_iter(mx.io.DataIter):
    ...
    @property
    def provide_label(self):
        return [('att_net_label', (self.batch_size, )), ('part_net_label', (self.batch_size, )), ('master_net_label', (self.batch_size, )),('part_net_aux_label', (self.batch_size, )), ('master_net_aux_label', (self.batch_size, ))]
    ...
    def next(self):
        ...
        final_label = [label, label, label, label, label]

        return mx.io.DataBatch(data=batch.data, label=final_label, pad=batch.pad, index=batch.index)



def get_custom_iter(args, kv=None):
    train, val = get_rec_iter(args, kv)
    return (custom_iter(train), custom_iter(val))
